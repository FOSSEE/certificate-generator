...
urlpatterns = patterns('certificate.views',
    ...
    url(r'^fellowship/2022/$', 'fellow22_certificate_download',
        name='fellow22_certificate_download'),
    url(r'^fellowship/2023/$', 'fellow23_certificate_download',
        name='fellow23_certificate_download'),
    url(r'^fellowship/2024/$', 'fellow24_certificate_download',
        name='fellow24_certificate_download'),
    url(r'^fellowship/2025/$', 'fellow25_certificate_download',
        name='fellow25_certificate_download'),
    url(r'^fellowship/2026/$', 'fellow26_certificate_download',
        name='fellow26_certificate_download'),
    url(r'^gis/$', 'gis_certificate_download',
        name='gis_certificate_download'),
    url(r'^women-day/2025/$', 'women_day_certificate_download',
        name='women_day_certificate_download'),
    url(r'^cfd/workshop/2025/$', 'cfd_workshop_certificate_download',
        name='cfd_workshop_certificate_download'),
    url(r'^dac/2025/$', 'desktop_competition_certificate_download',
        name='desktop_competition_certificate_download'),
    url(r'^gis/workshop/advanced/$', 'gis_insight_certificate_download',
        name='gis_insight_certificate_download'),
    ...
    url(r'^internship_certificate/2022/$', 'intern22_certificate_download',
        name='intern22_certificate_download'),
    url(r'^internship/2023/$', 'intern23_certificate_download',
        name='intern23_certificate_download'),
    url(r'^animate/2024/$', 'animate_certificate_download',
        name='animate_certificate_download'),
    url(r'^animate/2025/$', 'animate_2025_certificate_download',
        name='animate_2025_certificate_download'),
    url(r'^internship/2024/$', 'intern24_certificate_download',
        name='intern24_certificate_download'),
    url(r'^internship/2025/$', 'intern25_certificate_download',
        name='intern25_certificate_download'),
    url(r'^internship/2026/$', 'intern26_certificate_download',
        name='intern26_certificate_download'),
    ...
    url(r'^scilab/hackathon/casestudy/2025/$', 'scsh_certificate_download',
        name='scsh_certificate_download'),
    url(r'^hackathon/python/$', 'python_hackathon_certificate_download',
        name='python_hackathon_certificate_download'),
    url(r'^hackathon/openfoam/$', 'openfoam_hackathon_certificate_download',
        name='openfoam_hackathon_certificate_download'),
    url(r'^arduino/$', 'arduino_certificate_download',
        name='arduino_certificate_download'),
    url(r'^arduino/(?P<year>.*)/$', 'arduino_day_certificate_download',
        name='arduino_day_certificate_download'),
    url(r'^arduino/workshop/$', 'arduino_workshop_certificate_download',
        name='arduino_workshop_certificate_download'),
    url(r'^koha/workshop/$', 'koha_workshop_certificate_download',
        name='koha_workshop_certificate_download'),
    url(r'^arduino/workshop/iit/$', 'arduino_workshop_st_certificate_download',
        name='arduino_workshop_st_certificate_download'),
    url(r'^iot/hackathon/$', 'iot_hackathon_certificate_download',
        name='iot_hackathon_certificate_download'),
    url(r'^faculty/st/$', 'vit_certificate_download',
        name='vit_certificate_download'),
    url(r'^faculty/nfdp/$', 'nfdp_certificate_download',
        name='nfdp_certificate_download'),
    url(r'^fdp/esim/2026/$', 'sfdp_esim_certificate_download',
        name='sfdp_esim_certificate_download'),
    url(r'^fdp/cfd/2026/$', 'sfdp_cfd_certificate_download',
        name='sfdp_cfd_certificate_download'),
    url(r'^faculty/fdp/floss/$', 'ffdp_certificate_download',
        name='ffdp_certificate_download'),
    ...
    url(r'^mapathon/2023/$', 'mapathon2023_certificate_download',
        name='mapathon2023_certificate_download'),
    url(r'^mapathon/(?P<year>.*)/$', 'mapathon2023_certificate_download',
        name='mapathon2023_certificate_download'),
    url(r'^hackathon/(?P<year>.*)/$', 'hackathon2025_certificate_download',
        name='hackathon2025_certificate_download'),
    url(r'^animation/2d/2023/$', 'all_india_animation_certificate_download',
        name='all_india_animation_certificate_download'),
    ...
    url(r'^esim/marathon/2025$', 'esim_marathon_2025_certificate_download',
        name='esim_marathon_2025_certificate_download'),
