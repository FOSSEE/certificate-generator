...
from certificate.models import Scilab_participant, Certificate, Event, Scilab_speaker, Scilab_workshop, Question, Answer, FeedBack, Scipy_participant, Scipy_speaker, Drupal_camp, Tbc_freeeda
import subprocess
import os
    ...
    if _type == 'key':
        try:
            ...
            if type == 'P':
                ...
                if purpose == 'FreeEDA Textbook Companion':
